package com.zp4rker.dscrd.core.yaml.file;

import com.zp4rker.dscrd.core.logger.ZLogger;
import com.zp4rker.dscrd.core.yaml.Configuration;
import com.zp4rker.dscrd.core.yaml.ConfigurationSection;
import com.zp4rker.dscrd.core.yaml.InvalidConfigurationException;
 ...
 */
public class Yaml extends FileConfiguration {
    protected static final String COMMENT_PREFIX = "# ";
    protected static final String BLANK_CONFIG = "{}\n";
    private final DumperOptions yamlOptions = new DumperOptions();
    private final Representer yamlRepresenter = new YamlRepresenter();
    private final org.yaml.snakeyaml.Yaml yaml = new org.yaml.snakeyaml.Yaml(new YamlConstructor(), yamlRepresenter, yamlOptions);
    ...
    /**
     * Creates a new {@link Yaml}, loading from the given stream.
     * <p/>
     * Any errors loading the Configuration will be logged and then ignored.
     * If the specified input is not a valid config, a blank config will be
     * returned.
